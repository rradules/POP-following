...
fn = "<(python3 avg_stats.py -1 out-random-hidden50-lr0.001-forwardreturn-extranone-*)"
fb = "<(python3 avg_stats.py -1 out-random-hidden50-lr0.001-forwardreturn-extraaccrued-*)"
bn = "<(python3 avg_stats.py -1 out-random-hidden50-lr0.001-bothreturn-extranone-*)"
bb = "<(python3 avg_stats.py -1 out-random-hidden50-lr0.001-bothreturn-extraaccrued-*)"
bbn = "<(python3 avg_stats.py -1 out-random-hidden50-lr0.001-bothbuggyreturn-extranone-*)"
bbb = "<(python3 avg_stats.py -1 out-random-hidden50-lr0.001-bothbuggyreturn-extraaccrued-*)"
tn = "<(python3 avg_stats.py -1 out-random-hidden50-lr0.001-triplereturn-extranone-*)"
tb = "<(python3 avg_stats.py -1 out-random-hidden50-lr0.001-triplereturn-extraaccrued-*)"

plot [0:200] [1000:3100] \
